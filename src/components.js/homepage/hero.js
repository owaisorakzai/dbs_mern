...
<div className="relative bg-gray-50 overflow-hidden">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h16"></path>
          ...
          <div className="hidden md:flex md:space-x-10">
              ...
              <a href="/" className="font-medium text-gray-500 hover:text-gray-900">Self Check</a>
            
              <a href="/" className="font-medium text-gray-500 hover:text-gray-900">Organization Check</a>
      ...
      <main className="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
        <div className="text-center">
          <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            <span className="block xl:inline">We are the</span>
            <span className="block text-indigo-600 xl:inline">best</span>
          </h1>
          ...
          <div className="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
            <div className="rounded-md shadow">
              <a href="/form" className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10">
                Self Check
              </a>
            </div>
